      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="rounded border p-3 md:p-4 space-y-2">
            ...
            {walletAddress ? (
              <Link href="/vault" className="mt-2 block w-full"><Button className="w-full block" variant="outline">Go to Vault</Button></Link>
            ) : (
              <Button className="mt-2 w-full block" variant="outline" disabled>Go to Vault</Button>
            )}
          </div>
          <div className="rounded border p-3 md:p-4 space-y-2">
            ...
            {walletAddress ? (
              <Link href="/issuers" className="mt-2 block w-full"><Button className="w-full block" variant="outline">Go to Authorized Issuers</Button></Link>
            ) : (
              <Button className="mt-2 w-full block" variant="outline" disabled>Go to Authorized Issuers</Button>
            )}
          </div>
          <div className="rounded border p-3 md:p-4 space-y-2">
            ...
            {walletAddress ? (
              <Link href="/did" className="mt-2 block w-full"><Button className="w-full block" variant="outline">Go to DID</Button></Link>
            ) : (
              <Button className="mt-2 w-full block" variant="outline" disabled>Go to DID</Button>
            )}
          </div>
          <div className="rounded border p-3 md:p-4 space-y-2">
            ...
            {walletAddress ? (
              <Link href="/credentials" className="mt-2 block w-full"><Button className="w-full block" variant="outline">Go to Credentials</Button></Link>
            ) : (
              <Button className="mt-2 w-full block" variant="outline" disabled>Go to Credentials</Button>
            )}
          </div>
        </div>
      </div>
